void PROscore_MINI() {
  ...
  text("FOUL", width/7, (height/40)*16);
  text("FOUL", (width/15)*13, (height/40)*16);
  ...
  //HOME FOUL
  fill(0);
  rect(width/7, (height/100)*54, height/15, height/10);
  fill(#00ff00);
  textSize(height/6);
  if (HomeFoul==6) {
    text("P", width/7, (height/100)*54);
  } else {
    text(str_HomeFoul, width/7, (height/100)*54);
  }

  //GUEST FOUL
  fill(0);
  rect((width/15)*13, (height/100)*54, height/15, height/10);
  fill(#00ff00);
  textSize(height/6);
  if (GuestFoul==6) {
    text("P", (width/15)*13, (height/100)*54);
  } else {
    text(str_GuestFoul, (width/15)*13, (height/100)*54);
  }
